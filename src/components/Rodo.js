    ...
    return (
        <div className='rodo'>
            ...
            <p>Wypełniając obowiązek informacyjny wynikający z art. 13 ogólnego Rozporządzenia o ochronie danych osobowych z dnia 27 kwietnia 2016r. (Dz. Urz. UE L 119 z 04.05.2016), aby zapewnić Państwu kontrolę nad sposobem wykorzystywania Państwa danych osobowych informuję, iż:
                ...
                <br />
                <br />
                2. Pani/Pana dane osobowe przetwarzane będą na podstawie art. 6 ust. 1 ogólnego Rozporządzenia o ochronie danych osobowych z dnia 27 kwietnia 2016r. w celu wymienionym w powyższym
                przepisie w takim zakresie, w jakim – spełniony jest co najmniej jeden z poniższych warunków:
                <br />
